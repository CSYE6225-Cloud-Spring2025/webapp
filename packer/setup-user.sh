...
# provide app directory permissions to the user and group
sudo chown -R "$APP_USER":"$APP_GROUP" /opt/csye6225
sudo chmod -R 750 /opt/csye6225

# provide log directory permissions to the user and group
sudo chown -R "$APP_USER":"$APP_GROUP" /var/log/nodejs
sudo chmod -R 750 /var/log/nodejs

# provide cloudwatch config directory permissions to the user and group
